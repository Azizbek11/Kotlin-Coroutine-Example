package com.parvoz.example.coroutines.utils

import androidx.lifecycle.ViewModel
import androidx.lifecycle.ViewModelProvider
import com.parvoz.example.coroutines.data.api.ApiHelper
import com.parvoz.example.coroutines.data.local.DatabaseHelper
import com.parvoz.example.coroutines.learn.errorhandling.exceptionhandler.ExceptionHandlerViewModel
import com.parvoz.example.coroutines.learn.errorhandling.supervisor.IgnoreErrorAndContinueViewModel
import com.parvoz.example.coroutines.learn.errorhandling.trycatch.TryCatchViewModel
import com.parvoz.example.coroutines.learn.retrofit.parallel.ParallelNetworkCallsViewModel
import com.parvoz.example.coroutines.learn.retrofit.series.SeriesNetworkCallsViewModel
import com.parvoz.example.coroutines.learn.retrofit.single.SingleNetworkCallViewModel
import com.parvoz.example.coroutines.learn.room.RoomDBViewModel
import com.parvoz.example.coroutines.learn.task.onetask.LongRunningTaskViewModel
import com.parvoz.example.coroutines.learn.task.twotasks.TwoLongRunningTasksViewModel
import com.parvoz.example.coroutines.learn.timeout.TimeoutViewModel
